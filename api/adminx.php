...
$auth_users = array(
    'admin' => '$2y$10$sn.E2lFRY3ysEZ8QcKX9MOTIbo3sXDehT0rWUaqB32IfW8VQougYC'
);
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <script>
        Dropzone.options.fileUploader = {
            ...
            retryChunksLimit: 3,
            parallelUploads: 1,
			dictDefaultMessage: "请选择或拖动文件到此处",
...
if (isset($_GET['copy']) && !isset($_GET['finish']) && !FM_READONLY) {
    ...
    <div class="path">
        <p><b>复制</b></p>
        <p class="break-word">
            <strong>原文件路径:</strong> <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . $copy)) ?><br>
            <strong>目标路径:</strong> <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH)) ?>
        </p>
        <p>
            <b><a href="?p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1"><i class="fa fa-check-circle"></i> 复制</a></b> &nbsp;
            <b><a href="?p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1&amp;move=1"><i class="fa fa-check-circle"></i> 移动</a></b> &nbsp;
            <b><a href="?p=<?php echo urlencode(FM_PATH) ?>" class="text-danger"><i class="fa fa-times-circle"></i> 取消</a></b>
        </p>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a target="_blank" class="app-v-title"> TF文件管理器 <?php echo VERSION; ?></a></h3></p>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <p class="break-word">
                ...
                <strong>文件大小:</strong> <?php echo ($filesize_raw <= 1000) ? "$filesize_raw bytes" : $filesize; ?><br>
                <strong>文件类型:</strong> <?php echo $mime_type ?><br>
                <?php
                // ZIP info
            ...
            <div class="edit-file-actions col-xs-12 col-sm-7 col-lg-6 text-end pt-1">
                ...
                <?php if ($is_text) { ?>
                    <?php if ($isNormalEditor) { ?>
                        ...
                        <button type="button" class="btn btn-sm btn-success" name="Save" data-url="<?php echo fm_enc($file_url) ?>" onclick="edit_save(this,'nrl')"><i class="fa fa-floppy-o"></i> <?php echo lng('Save') ?>
                        </button>
                    <?php } else { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a target="_blank" class="float-right text-muted">TF文件管理器 <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a target="_blank" class="float-right text-muted">TF文件管理器 <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
                ...
                <ul class="navbar-nav justify-content-end <?php echo fm_get_theme();  ?>">
                    ...
                    <li class="nav-item avatar dropdown">
                        ...
                        <div class="dropdown-menu text-small shadow <?php echo fm_get_theme(); ?>" aria-labelledby="navbarDropdownMenuLink-5">
							...
							<?php endif ?>
							--->
                            <a title="查看探针信息" class="dropdown-item nav-link" href="tz.php" target="_blank"><i class="fa fa-location-arrow" aria-hidden="true"></i> 探针信息</a>
							<a title="数据库管理" class="dropdown-item nav-link" href="sql.php" target="_blank"><i class="fa fa-database" aria-hidden="true"></i> 数据库管理</a>
